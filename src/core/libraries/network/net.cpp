...
#if defined(__linux__) && !(defined(__ANDROID__) && __ANDROID_API__ < 35)
...
#else
        // bionic only declares epoll_pwait2 from API level 35; fall back to millisecond
        // resolution, as the non-Linux path already does.
